...
class BedWars extends PluginBase implements Listener {
    ...
    public function onChat(PlayerChatEvent $event) {
        ...
        switch ($args[0]) {
            ...
            case "spawn":
                ...
                if(!in_array($args[1], ["red", "blue", "yellow", "green", "aqua", "white", "pink", "grau"])){
                    break;
                }
                if($args[1] == "red") {
                ...
                if($args[1] == "blue") {
                    $arena->data["spawns"]["spawn-3"] = (new Vector3(floor($player->getX()) + 0.0, floor($player->getY()), floor($player->getZ()) + 0.0))->__toString();
                    $arena->data["spawns"]["spawn-4"] = (new Vector3(floor($player->getX()) + 0.0, floor($player->getY()), floor($player->getZ()) + 0.0))->__toString();
                    $player->sendMessage("§a> Spawn $args[1] set to X: " . (string)floor($player->getX()) . " Y: " . (string)floor($player->getY()) . " Z: " . (string)floor($player->getZ()));
                    break;
                }
                if($args[1] == "yellow") {
                    $arena->data["spawns"]["spawn-5"] = (new Vector3(floor($player->getX()) + 0.0, floor($player->getY()), floor($player->getZ()) + 0.0))->__toString();
                    $arena->data["spawns"]["spawn-6"] = (new Vector3(floor($player->getX()) + 0.0, floor($player->getY()), floor($player->getZ()) + 0.0))->__toString();
                    $player->sendMessage("§a> Spawn $args[1] set to X: " . (string)floor($player->getX()) . " Y: " . (string)floor($player->getY()) . " Z: " . (string)floor($player->getZ()));
                    break;
                }
                if($args[1] == "green") {
                    $arena->data["spawns"]["spawn-7"] = (new Vector3(floor($player->getX()) + 0.0, floor($player->getY()), floor($player->getZ()) + 0.0))->__toString();
                    $arena->data["spawns"]["spawn-8"] = (new Vector3(floor($player->getX()) + 0.0, floor($player->getY()), floor($player->getZ()) + 0.0))->__toString();
                    $player->sendMessage("§a> Spawn $args[1] set to X: " . (string)floor($player->getX()) . " Y: " . (string)floor($player->getY()) . " Z: " . (string)floor($player->getZ()));
                    break;
                }
                if($args[1] == "aqua") {
                    $arena->data["spawns"]["spawn-9"] = (new Vector3(floor($player->getX()) + 0.0, floor($player->getY()), floor($player->getZ()) + 0.0))->__toString();
                    $arena->data["spawns"]["spawn-10"] = (new Vector3(floor($player->getX()) + 0.0, floor($player->getY()), floor($player->getZ()) + 0.0))->__toString();
                    $player->sendMessage("§a> Spawn $args[1] set to X: " . (string)floor($player->getX()) . " Y: " . (string)floor($player->getY()) . " Z: " . (string)floor($player->getZ()));
                    break;
                }
                if($args[1] == "white") {
                    $arena->data["spawns"]["spawn-11"] = (new Vector3(floor($player->getX()) + 0.0, floor($player->getY()), floor($player->getZ()) + 0.0))->__toString();
                    $arena->data["spawns"]["spawn-12"] = (new Vector3(floor($player->getX()) + 0.0, floor($player->getY()), floor($player->getZ()) + 0.0))->__toString();
                    $player->sendMessage("§a> Spawn $args[1] set to X: " . (string)floor($player->getX()) . " Y: " . (string)floor($player->getY()) . " Z: " . (string)floor($player->getZ()));
                    break;
                }
                if($args[1] == "pink") {
                    $arena->data["spawns"]["spawn-13"] = (new Vector3(floor($player->getX()) + 0.0, floor($player->getY()), floor($player->getZ()) + 0.0))->__toString();
                    $arena->data["spawns"]["spawn-14"] = (new Vector3(floor($player->getX()) + 0.0, floor($player->getY()), floor($player->getZ()) + 0.0))->__toString();
                    $player->sendMessage("§a> Spawn $args[1] set to X: " . (string)floor($player->getX()) . " Y: " . (string)floor($player->getY()) . " Z: " . (string)floor($player->getZ()));
                    break;
                }
                if($args[1] == "gray") {
                    $arena->data["spawns"]["spawn-15"] = (new Vector3(floor($player->getX()) + 0.0, floor($player->getY()), floor($player->getZ()) + 0.0))->__toString();
                    $arena->data["spawns"]["spawn-16"] = (new Vector3(floor($player->getX()) + 0.0, floor($player->getY()), floor($player->getZ()) + 0.0))->__toString();
                    $player->sendMessage("§a> Spawn $args[1] set to X: " . (string)floor($player->getX()) . " Y: " . (string)floor($player->getY()) . " Z: " . (string)floor($player->getZ()));
                    break;
                }
                break;
            ...
            case "savelevel":
                if(!$arena->level instanceof Level) {
                    ...
                    if($arena->setup) {
                        $player->sendMessage("§6§lERROR!§r§6 ...");
                    }
                    break;
                }
    ...
    public function addRewardWin(Player $player) {
        ...
        $player->sendMessage("§6+5Tokens! (Win)");
        $player->addXpLevel(5);
        $player->sendMessage("§a5Xp+! (Win)");
    } 

    public function addRewardBed(Player $player) {
        $name = $player->getName();
        EconomyAPI::getInstance()->addMoney($name, 3);
        $player->sendMessage("§6+3Tokens! (Bed  broken)");
        $player->addXpLevel(1);
        $player->sendMessage("§a1Xp+! (Bed broken)");
    }

    public function addRewardFkill(Player $player) {
        $name = $player->getName();
        EconomyAPI::getInstance()->addMoney($name, 2);
        $player->sendMessage("§6+2Tokens! (Final Kill)");
        $player->addXpLevel(3);
        $player->sendMessage("§a3Xp+! (Final Kill)");
    }

    public function addRewardKill(Player $player) {
        $name = $player->getName();
        EconomyAPI::getInstance()->addMoney($name, 1);
        $player->sendMessage("§6+1Tokens! (Kill)");
        $player->addXpLevel(1);
        $player->sendMessage("§a1Xp+! (Kill)");
    }
    ...
    public function spawnSpectre(Player $sender) {
      ...
      $sender->getServer()->dispatchCommand($sender, "s s h");
      $sender->getServer()->dispatchCommand($sender, "s s i");
      $sender->getServer()->dispatchCommand($sender, "s s j");
      $sender->getServer()->dispatchCommand($sender, "s s k");
      $sender->getServer()->dispatchCommand($sender, "s s l");
      $sender->getServer()->dispatchCommand($sender, "s s m");
      $sender->getServer()->dispatchCommand($sender, "s s n");
      $sender->getServer()->dispatchCommand($sender, "s s o");
    }
    
  public function spectreJoin(Player $sender) {
      $sender->getServer()->dispatchCommand($sender, "s c a /bwd random");
      $sender->getServer()->dispatchCommand($sender, "s c b /bwd random");
      $sender->getServer()->dispatchCommand($sender, "s c c /bwd random");
      $sender->getServer()->dispatchCommand($sender, "s c d /bwd random");
      $sender->getServer()->dispatchCommand($sender, "s c e /bwd random");
      $sender->getServer()->dispatchCommand($sender, "s c f /bwd random");
      $sender->getServer()->dispatchCommand($sender, "s c g /bwd random");
      $sender->getServer()->dispatchCommand($sender, "s c h /bwd random");
      $sender->getServer()->dispatchCommand($sender, "s c i /bwd random");
      $sender->getServer()->dispatchCommand($sender, "s c j /bwd random");
      $sender->getServer()->dispatchCommand($sender, "s c k /bwd random");
      $sender->getServer()->dispatchCommand($sender, "s c l /bwd random");
      $sender->getServer()->dispatchCommand($sender, "s c m /bwd random");
      $sender->getServer()->dispatchCommand($sender, "s c n /bwd random");
      $sender->getServer()->dispatchCommand($sender, "s c o /bwd random");
    }
  ...
  public function spectreLeave(Player $sender) {
      ...
      $sender->getServer()->dispatchCommand($sender, "kick h");
      $sender->getServer()->dispatchCommand($sender, "kick i");
      $sender->getServer()->dispatchCommand($sender, "kick j");
      $sender->getServer()->dispatchCommand($sender, "kick k");
      $sender->getServer()->dispatchCommand($sender, "kick l");
      $sender->getServer()->dispatchCommand($sender, "kick m");
      $sender->getServer()->dispatchCommand($sender, "kick n");
      $sender->getServer()->dispatchCommand($sender, "kick o");
  }
}
