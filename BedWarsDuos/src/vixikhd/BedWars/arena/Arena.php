...
class Arena implements Listener
{
    ...
    public function selectTeam($player)
    {
        ...
        $form->addButton("§eYELLOW§r\n" . count($this->yellowteam));
        $form->addButton("§aGREEN§r\n" . count($this->greenteam));
        $form->addButton("§bAQUA§r\n" . count($this->aquateam));
        $form->addButton("§fWHITE§r\n" . count($this->whiteteam));
        $form->addButton("§dPINK§r\n" . count($this->pinkteam));
        $form->addButton("§8GRAY§r\n" . count($this->grayteam));                
            ...
            if ($block instanceof Bed) {
                ...
                if (
                    in_array(
                        ...
                        [$red, $blue, $yellow, $green, $aqua, $white $pink, $gray]
                    )
                ) {
                    $team = null;
                    if ($pos == $red) {
