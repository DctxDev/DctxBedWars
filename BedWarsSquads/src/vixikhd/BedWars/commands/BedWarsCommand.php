...
class BedWarsCommand extends Command implements PluginIdentifiableCommand {
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args) {
        if(!isset($args[0])) {
            $sender->sendMessage("§cUsage: §7/bwsd help");
            return;
        }
        switch ($args[0]) {
             case "help":
                if(!$sender->hasPermission("bwsd.cmd.help")) {
                    $sender->sendMessage("§cYou have not permissions to use this command!");
                    break;
                }
                $sender->sendMessage("§a> BedWars commands:\n" .
                    "§7/bwsd help : Displays list of BedWars commands\n".
                    "§7/bwsd create : Create BedWars arena\n".
                    "§7/bwsd remove : Remove BedWars arena\n".
                    "§7/bwsd set : Set BedWars arena\n".
                    "§7/bwsd random : Join random arena BedWars\n".
                    "§7/bwsd test : Test BedWars\n".
                    "§7/bwsd stoptest : Stop test BedWars\n".
                    "§7/bwsd arenas : Displays list of arenas");
                break;
            case "create":
                if(!$sender->hasPermission("bwsd.cmd.create")) {
                    $sender->sendMessage("§cYou have not permissions to use this command!");
                    break;
                }
                if(!isset($args[1])) {
                    $sender->sendMessage("§cUsage: §7/bwsd create <arenaName>");
                    break;
                }
                ...
                break;
            case "remove":
                if(!$sender->hasPermission("bwsd.cmd.remove")) {
                    $sender->sendMessage("§cYou have not permissions to use this command!");
                    break;
                }
                if(!isset($args[1])) {
                    $sender->sendMessage("§cUsage: §7/bwsd remove <arenaName>");
                    break;
                }
                if(!isset($this->plugin->arenas[$args[1]])) {
                ...
                break;
            case "set":
                if(!$sender->hasPermission("bwsd.cmd.set")) {
                    $sender->sendMessage("§cYou have not permissions to use this command!");
                    break;
                }
                ...
                if(!isset($args[1])) {
                    $sender->sendMessage("§cUsage: §7/bwsd set <arenaName>");
                    break;
                }
            ...
            case "random":
                ...
                break;
            case "test":
                if(!$sender->hasPermission("bwsd.cmd.test")) {
                    $sender->sendMessage("§cYou have not permissions to use this command!");
                    break;
                }
                if(!$sender instanceof Player) {
                ...
                break;
            case "stoptest":
                if(!$sender->hasPermission("bwsd.cmd.stoptest")) {
                    $sender->sendMessage("§cYou have not permissions to use this command!");
                    break;
                }
                if(!$sender instanceof Player) {
                ...
                break;
            case "arenas":
                if(!$sender->hasPermission("bwsd.cmd.arenas")) {
                    $sender->sendMessage("§cYou have not permissions to use this command!");
                    break;
                }
