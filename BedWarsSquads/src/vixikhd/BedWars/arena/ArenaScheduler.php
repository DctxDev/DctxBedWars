        ...
        switch ($this->plugin->phase) {
            case Arena::PHASE_LOBBY:
                foreach($this->plugin->players as $player){
                    ...
                    $api->setLine($player, 7, "§fMode: §eSquads");
                ...
                if(count($this->plugin->players) >= 8) {
                    ...
                    $api->setLine($player, 9, "§fTeam: {$color[$team]}");
                    $api->setLine($player, 10, "  ");
                    $api->setLine($player, 11, "§eplay.dctxgames.com");
                }
                    $this->waitTime--;
                    }
                    if($this->waitTime <= 10) {
            ...
            case Arena::PHASE_GAME:
                ...
                foreach($this->plugin->players as $player){
                    ...
                    $api->setLine($player, 10, "§f: §e{$kills}");
                    $api->setLine($player, 11, "§f: §e{$fkills}");
                    $api->setLine($player, 12, "§f⨳: §e{$broken}");
            ...
            case Arena::PHASE_RESTART:
                foreach($this->plugin->players as $player){
                    ...
                    $api = Scoreboards::getInstance();
                    $api->new($player, "BedWars", "§l§bBEDWARS");
                    $api->setLine($player, 1, "§7{$date}"); 
                    $api->setLine($player, 2, " "); 
