...
class BedWars extends PluginBase implements Listener {
    ...
    public function addRewardWin(Player $player) {
        ...
        $player->sendMessage("§6+10Tokens! (Win)");
        $player->addXpLevel(15);
        $player->sendMessage("§a15Xp+! (Win)");
    } 

    public function addRewardBed(Player $player) {
        $name = $player->getName();
        EconomyAPI::getInstance()->addMoney($name, 5);
        $player->sendMessage("§6+5Tokens! (Bed  broken)");
        $player->addXpLevel(7);
        $player->sendMessage("§a7Xp+! (Bed broken)");
    }

    public function addRewardFkill(Player $player) {
        $name = $player->getName();
        EconomyAPI::getInstance()->addMoney($name, 5);
        $player->sendMessage("§6+5Tokens! (Final Kill)");
        $player->addXpLevel(5);
        $player->sendMessage("§a5Xp+! (Final Kill)");
    }

    public function addRewardKill(Player $player) {
        $name = $player->getName();
        EconomyAPI::getInstance()->addMoney($name, 3);
        $player->sendMessage("§6+3Tokens! (Kill)");
        $player->addXpLevel(3);
        $player->sendMessage("§a3Xp+! (Kill)");
    }
  ...
  public function spectreJoin(Player $sender) {
      $sender->getServer()->dispatchCommand($sender, "s c a /bwsd random");
      $sender->getServer()->dispatchCommand($sender, "s c b /bwsd random");
      $sender->getServer()->dispatchCommand($sender, "s c c /bwsd random");
      $sender->getServer()->dispatchCommand($sender, "s c d /bwsd random");
      $sender->getServer()->dispatchCommand($sender, "s c e /bwsd random");
      $sender->getServer()->dispatchCommand($sender, "s c f /bwsd random");
      $sender->getServer()->dispatchCommand($sender, "s c g /bwsd random");
      $sender->getServer()->dispatchCommand($sender, "s c h /bwsd random");
      $sender->getServer()->dispatchCommand($sender, "s c i /bwsd random");
      $sender->getServer()->dispatchCommand($sender, "s c j /bwsd random");
      $sender->getServer()->dispatchCommand($sender, "s c k /bwsd random");
      $sender->getServer()->dispatchCommand($sender, "s c l /bwsd random");
      $sender->getServer()->dispatchCommand($sender, "s c m /bwsd random");
      $sender->getServer()->dispatchCommand($sender, "s c n /bwsd random");
      $sender->getServer()->dispatchCommand($sender, "s c o /bwsd random");
    }
